...
/*===============================
/modules/mod_noo_timeline/assets/js/script.js
================================================================================*/;
!function($){"use strict";$.fn.nootimeline=function(options){return this.each(function(){var $this=$(this),controls=$this.find(".noo-tl-control,.noo-tl-time,.noo-tl-title");controls.click(function(){var that=$(this),parent=that.closest(".noo-tl-item");if(parent.hasClass("selected")){parent.removeClass("selected").find(".noo-tl-desc").hide(400);}else{var selected=$this.find(".selected");if(selected){selected.removeClass("selected").find(".noo-tl-desc").hide(400);}
